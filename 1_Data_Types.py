# -------- understand data types, data structures and advance data structures ----------

# define variable and assign values to variables
a = 4
b = 4
...
print(tup)
# tup[1] = 22.5 # assign new value to tuple - error will be occurred
...
dic = {"ID": 10, "Name": "Pandit", "Salary": 20000}
print(type(dic))
print(dic["ID"])
print(dic["Salary"])
print(type(dic["ID"]))

# list -> numpy array (4 times faster, store a column) -> pandas , store data in tabular format row, column,
# header in data frane
